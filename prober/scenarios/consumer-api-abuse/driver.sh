...
#
# Scenario: CONSUMER PER-REQUEST ALLOCATION NEUTRALITY for ngx_http_api_abuse_module.so.
...
if [ "$SIG_SEEN" -eq 1 ]; then
    echo "ok 2 - the configured path serves with api_abuse enforcing (WEAK -- no observable signature, see driver)"
else
